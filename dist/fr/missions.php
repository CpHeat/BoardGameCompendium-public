<?php
  include_once('../config/main_functions.php');
  ...
  if($maintenance && !($_SERVER['REMOTE_ADDR']=='82.64.10.182' || $_SERVER['REMOTE_ADDR']=='127.0.0.1')){
    ...
    include($_SERVER['DOCUMENT_ROOT'].'/includes/functions/missions_functions.php');
    ...
    include($_SERVER['DOCUMENT_ROOT'].'/includes/missions.php');
